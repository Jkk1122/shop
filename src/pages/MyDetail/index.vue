      ...
      <div class="mainCon">
        ...
        <div class="InfoWrap">
          <div class="goodsDetail">
            ...
            <p class="news">{{skuInfo.skuDesc}}返</p>
            <div class="priceArea">
          ...
          <div class="choose">
            <div class="chooseArea">
              ...
              <dl v-for="spuSale in spuSaleAttrList" :key="spuSale.id">
                ...
                :key="value.id"
                @click="changeActive(value,spuSale.spuSaleAttrValueList)"
            ...
            <div class="cartWrap">
              ...
              <div class="add">
                <a @click="sendShopCarData">加入购物车</a>
              </div>
            </div>
          </div>
        </div>
...
<script>
  ...
  export default {
    ...
    methods:{
      ...
      // 用户选中商品数目
      changeSkuNum(e){
        // 给用户输入的值进行乘1操作    ** 给字符类型乘数字会变为NaN
        let value = e.target.value *1
        // 如果为NaN或者小于1 那么就将skuNum的值设置为1
      ...
      // 购物车数据的发送
      async sendShopCarData(){
        
        try {
          // 成功发送请求
          await this.$store.dispatch('getUpdateShopCar',{skuId:this.$route.params.skuId,skuNum:this.skuNum})
          // 发送成功请求后，将进行路由的跳转
          // 传递简单参数
