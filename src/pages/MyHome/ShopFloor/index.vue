      ...
      <div class="tab-content">
        <div class="tab-pane">
          <div class="floor-1">
            <div class="blockgary">
              <ul class="jd-list">
                <li v-for="(word, index) in floorlist.keywords" :key="index">
                  {{ word }}
                </li>
              </ul>
            ...
            <div class="floorBanner">
                <!-- 轮播图 -->
            <AllCanousel :list="floorlist.carouselList"/>
            </div>
            <div class="split">
...
<script>
import AllCanousel from '/qianduanlearn/app/src/components/AllCarousel'
export default {
  name: "ShopFloor",
  props: ["floorlist"],
  components:{AllCanousel}
